namespace Cremeria.Forms.Reportes
{
	partial class Ventas_det
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Ventas_det));
			...
			this.reportViewer1.Size = new System.Drawing.Size(797, 393);
			...
			// Ffinal
			// 
			this.Ffinal.Location = new System.Drawing.Point(403, 9);
			...
			// Finicial
			// 
			this.Finicial.Location = new System.Drawing.Point(106, 10);
			...
			this.Name = "Ventas_det";
			this.Text = "Ventas detalladas";
			this.Load += new System.EventHandler(this.Ventas_det_Load);
