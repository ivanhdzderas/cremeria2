...
{
	partial class Global_promotores
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Global_promotores));
			...
			// dtInicial
			// 
			this.dtInicial.Location = new System.Drawing.Point(84, 12);
			...
			this.Name = "Global_promotores";
			this.Text = "Reporte Global";
			this.Load += new System.EventHandler(this.Global_promotores_Load);
