namespace Cremeria.Forms.Reportes
{
	partial class Reporte_ventas
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "Reporte de ventas global";
			...
			this.button2.Text = "Reporte de ventas con tickets";
			...
			this.button3.Text = "Reporte de ventas detallado";
			...
			this.button4.Text = "Ventas por promotor";
			...
			this.button5.Text = "Ventas Globales Promotores";
