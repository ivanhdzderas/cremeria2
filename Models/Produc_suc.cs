...
namespace Cremeria.Models
{
	public class Produc_suc : ConnectOtherDb
    {
        ...
        public void update_inventary()
        {
            ...
            runQuery(query, Forms.intercambios.conector);
        ...
        {
            string query = "INSERT INTO tbaproductos (codigo, descripcion, costo, codigo2, codigo3, codigo4, codigo5, precio1, precio2, precio3, precio4, precio5, utilidad1, utilidad2, utilidad3, utilidad4, utilidad5, cantidad, devolucion, unidad, grupo, marca, activo,codigo_sat,sku,medida_sat,impuesto_venta,impuesto_compra,descuento,monto_descuento,minimo,maximo,id_parent, c_unidad,dias_alerta, lote, max_p1,max_p2, max_p3,max_p4,max_p5, proveedor, grupal)";
            query += "values (";
            query += "'" + this.Code1 + "', ";
        ...
        public List<Produc_suc> getProductBycode1(string codigo)
        {
        ...
        public List<Produc_suc> getProductByproveedor(string proveedor)
        {
        ...
        public List<Produc_suc> getProductbymarca(string marca)
        {
        ...
        public List<Produc_suc> getProductById(int id)
        {
        ...
        public List<Produc_suc> getProduct(int parent)
        {
        ...
        public List<Produc_suc> getProductByCode(string code)
        {
        ...
        public List<Produc_suc> getProductByCodeAbsolute(string code)
        {
